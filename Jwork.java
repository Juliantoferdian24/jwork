...
{   
    ...
    public static void main(String[] args)
    {
        ...
        EwalletPayment Einvoice1 = new EwalletPayment(1, job1, myjobseeker2, InvoiceStatus.OnGoing);
        //EwalletPayment Einvoice2 = new EwalletPayment(2, job1, "14 April 2021",myjobseeker2,InvoiceStatus.OnGoing, myBonus1);
        //EwalletPayment Einvoice3 = new EwalletPayment(3, job1, "15 April 2021", myjobseeker2, InvoiceStatus.OnGoing, myBonus2);
